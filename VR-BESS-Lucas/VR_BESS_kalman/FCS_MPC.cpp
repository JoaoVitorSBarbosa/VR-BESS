 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Tue Feb 18 15:07:59 2025
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                FCS_MPC
...
/* Output Port  4 */
#define OUT_PORT_4_NAME                Ref_ILb
...
/* Output Port  5 */
#define OUT_PORT_5_NAME                Ref_ILs
...
#define NPARAMS                        0
#define SAMPLE_TIME_0                  1/100e+3
#define NUM_DISC_STATES                0
#define DISC_STATES_IC                 [0]
#define NUM_CONT_STATES                0
#define CONT_STATES_IC                 [0]
#define SFUNWIZ_GENERATE_TLC           0
#define SOURCEFILES                    "__SFB__INC_PATH C:\Users\Admin\Desktop\valac\lib\eigen-3.4.0\Eigen"
...
extern void FCS_MPC_Outputs_wrapper(const real_T *Vin,
  const real_T *ILs,
  const real_T *Vo,
  const real_T *Vcb,
  const real_T *ILb,
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port Vin of S-Function FCS_MPC");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port ILs of S-Function FCS_MPC");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port Vo of S-Function FCS_MPC");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port Vcb of S-Function FCS_MPC");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port ILb of S-Function FCS_MPC");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port Mod of S-Function FCS_MPC");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port q1 of S-Function FCS_MPC");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port q2 of S-Function FCS_MPC");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port q3 of S-Function FCS_MPC");
      return;
    }
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port S1 of S-Function FCS_MPC");
      return;
    }
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port S2 of S-Function FCS_MPC");
      return;
    }
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port Xo of S-Function FCS_MPC");
      return;
    }
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port Ref_Vo of S-Function FCS_MPC");
      return;
    }
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port Ref_ILb of S-Function FCS_MPC");
      return;
    }
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port Ref_ILs of S-Function FCS_MPC");
      return;
    }
...
{
  const real_T *Vin = (real_T *) ssGetInputPortRealSignal(S, 0);
  const real_T *ILs = (real_T *) ssGetInputPortRealSignal(S, 1);
  const real_T *Vo = (real_T *) ssGetInputPortRealSignal(S, 2);
  const real_T *Vcb = (real_T *) ssGetInputPortRealSignal(S, 3);
  const real_T *ILb = (real_T *) ssGetInputPortRealSignal(S, 4);
  const real_T *Mod = (real_T *) ssGetInputPortRealSignal(S, 5);
  const real_T *q1 = (real_T *) ssGetInputPortRealSignal(S, 6);
  const real_T *q2 = (real_T *) ssGetInputPortRealSignal(S, 7);
  const real_T *q3 = (real_T *) ssGetInputPortRealSignal(S, 8);
  real_T *S1 = (real_T *) ssGetOutputPortRealSignal(S, 0);
  real_T *S2 = (real_T *) ssGetOutputPortRealSignal(S, 1);
  real_T *Xo = (real_T *) ssGetOutputPortRealSignal(S, 2);
  real_T *Ref_Vo = (real_T *) ssGetOutputPortRealSignal(S, 3);
  real_T *Ref_ILb = (real_T *) ssGetOutputPortRealSignal(S, 4);
  real_T *Ref_ILs = (real_T *) ssGetOutputPortRealSignal(S, 5);
  FCS_MPC_Outputs_wrapper(Vin, ILs, Vo, Vcb, ILb, Mod, q1, q2, q3, S1, S2, Xo,
    Ref_Vo, Ref_ILb, Ref_ILs, S);
}
