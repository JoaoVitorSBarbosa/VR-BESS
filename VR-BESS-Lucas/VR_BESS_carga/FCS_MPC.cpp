 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Fri May 09 21:40:36 2025
 */
...
/* Output Port  6 */
#define OUT_PORT_6_NAME                y0
#define OUTPUT_6_DIMS_ND               {1,1}
#define OUTPUT_6_NUM_ELEMS             1
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port y0 of S-Function FCS_MPC");
      return;
    }
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  real_T *y0 = (real_T *) ssGetOutputPortRealSignal(S, 6);
  FCS_MPC_Outputs_wrapper(Vin, ILs, Vo, Vcb, ILb, Mod, S1, S2, Xo, Ref_Vo,
    Ref_ILb, Ref_ILs, y0);
}
